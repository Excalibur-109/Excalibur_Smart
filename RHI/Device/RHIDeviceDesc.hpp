...
struct RHIDeviceCreateDesc {
    ...
    bool ownsVulkanSurface = false;
    std::vector<const char*> requiredVulkanSurfaceInstanceExtensions;
    std::vector<const char*> optionalVulkanSurfaceInstanceExtensions;
